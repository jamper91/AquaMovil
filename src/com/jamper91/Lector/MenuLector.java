	...
	public void onDialogAceptarClick(DialogFragment dialog,String ciclo, String ruta) 
	{
		try
		{
			...
			if(validar(ciclo, ruta))
			{
				...
				dialogo("Los datos que intenta cargar para lecturas no est�n asignados al usuario, verifique el plan de lecturas con el administrador","Error");
			}
		}catch(Exception e)
		{
			dialogo("Los datos que intenta cargar para lecturas no est�n asignados al usuario, verifique el plan de lecturas con el administrador","Error L-ML-oDAC");
		}
